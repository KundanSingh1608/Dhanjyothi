...
public interface AccountService {
	...
	Account getAccountDetails(int userId, Character accountType) throws Exception;
	...
	void updateFromAccount(Account account,long transAmt,Transaction transaction, Account toAccount) throws Exception;
	
	void updateToAccount(Account account, long transAmt,Transaction transaction, Account fromAccount) throws Exception;
